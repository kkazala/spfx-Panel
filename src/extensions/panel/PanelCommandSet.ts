...
export default class PanelCommandSet extends BaseListViewCommandSet<IPanelCommandSetProperties> {
  ...
  public onInit(): Promise<void> {
    ...
    const _isListRegistered =
      this.context.listView.list.title === this.properties.listName
        ? true
        : false;
    ...
    const _setCommands = (): void => {
      const _setCommandState = (
        command: Command,
        config: IProcessConfigResult
      ): void => {
  ...
  public onExecute(event: IListViewCommandSetExecuteEventParameters): void {
    const _showComponent = (props: IMyComponentProps): void => {
      ...
      const element: React.ReactElement<IMyComponentProps> =
    ...
    const _showPanel = (props: IStatefulPanelProps): void => {
      ...
      const element: React.ReactElement<IStatefulPanelProps> =
        React.createElement(
          StatefulPanel,
          {
            ...props,
